    ...
    public static class DbInitializer
    {
        public static void Initialize(StoreContext context)
        {
            ...
            List<Product>? Products = new List<Product>{
                ...
                new Product {
                    Name = "https://i.ytimg.com/vi/p_is7qzLuFM/maxresdefault.jpg",
                    Description = "Italian supercar with V12 engine",
                    Price = 50000000,
                    PictureUrl = "https://www.lamborghini.com/sites/it-en/files/DAM/lamborghini/model/aventador/aventador-svj-roadster/configurator/01.jpg",
                    Brand = "Lamborghini",
                    Type = "New",
                    QuantityInStock = 5,
                },
                new Product {
                    ...
                    Price = 200000,
                    PictureUrl = "https://images.hgmsites.net/med/2022-porsche-911-gt3_100812284_m.jpg",
                    Brand = "Porsche",
                    Type = "New",
                    QuantityInStock = 15,
                },
